Public Class SavingConfirmForm
    Dim user As User
    Dim amount As String
    Dim method As String
    Dim path As String
    Private Sub SavingConfirmForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        renderValue()
    End Sub
    Public Sub New(user As User, amount As String, method As String, periodlist As ArrayList, dfperiod As String)
        ...
        If method.Split(".")(0) = "2" Then
            ...
            Me.path = "C:\Users\ASUS\source\repos\WindowsApp2\WindowsApp2\Profit_Period.txt"
        Else

            Me.path = "C:\Users\ASUS\source\repos\WindowsApp2\WindowsApp2\Profit_PerMonth.txt"
        End If
        'default period
    ...
    Private Function getPayingPermonth() As String
        ...
        Dim sum As Long = Long.Parse(CommonFunction.convertStringFormatToNumber(profit))
        Dim month As Integer = Integer.Parse(ComboBox1.SelectedItem.ToString.Split(".")(0))
    ...
    Private Function renderValue()
        ...
        End If
        Dim profit As Profit = CommonFunction.getProfit(Me.path, getKeyToCaculateProfit())
        If (profit.pProfit * 100) Mod Math.Round((profit.pProfit * 100), 0) = 0 Then
            TextBox4.Text = Math.Round(profit.pProfit * 100, 0) & "%"
        Else
            TextBox4.Text = Math.Round(profit.pProfit * 100, 2) & "%"
        End If
